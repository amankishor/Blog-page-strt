    ...
    <div className={`fixed top-0 left-0 w-full h-full flex items-center justify-center ${isOpen ? "" : "hidden"}`}>
        ...
        <div className='modal-conatiner'>
            <div className='bg-indigo-700 text-center p-5 h-96 lg:w-[500px] rounded shadow-md'>
                <h2 className='text-xl font-semibold  mt-6 mb-5 uppercase'>Please Login</h2>
                <form className='px-4'>
                    <div className='mb-5'>
                        <input type="email" name ="email" id ="email" placeholder='example@gamail.com' className='w-full rounded-md border
                ...
                {/* MOdal close button */}
                <button onClick={onClose} className='bg-gray-300 hover:bg-gray-4oo text-gray-800 font-semibold py-2 px-4 
                rounded inline-flex items-center mt-5'>
                    close
                </button>
